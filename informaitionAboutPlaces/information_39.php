...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/parksPlaces/vatanParkBlack.png" alt="">
        <h1 class="name-place">Этнический парк Ватан</h1>
        <p class="street-name-place">Заки Валиди 2А</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(176 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">«Ватан» — этнический парк в Уфе, открытый в целях ознакомления иностранных гостей с культурой Башкортостана в 2015. С момента открытия в качестве разового проекта, парк успел набрать популярность и стать одной из сил, притягивающей туристов в республику. Площадки и экспозиции парка «Ватан» целиком и полностью отражают самобытность Башкирии и знакомят с ней всех желающих посетителей. Комплекс состоит из нескольких юрт и окружающей их территории, которая используется для проведения показательных мероприятий.</br></p>
