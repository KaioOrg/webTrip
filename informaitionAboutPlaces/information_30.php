...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/restaurantsPlaces/odshahuriRestaurantBlack.png" alt="">
        <h1 class="name-place">Ресторан Оджахури</h1>
        <p class="street-name-place">Чернышевского 88</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(2460 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Добро пожаловать в наш грузинский дом «Оджахури». Дом, в котором царит атмосфера радушия, грузинского гостеприимства и семейного уюта в самом центре города по адресу: Чернышевского 88.</br></p>
