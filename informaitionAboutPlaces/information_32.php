...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/restaurantsPlaces/marcoPoloRestaurantBlack.png" alt="">
        <h1 class="name-place">Ресторан Marco Polo</h1>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(1424 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Без информации</br></p>
