...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/entertainmentsPlaces/koteynayaEntertainmentBlack.png" alt="">
        <h1 class="name-place">Котокафе "Котейная"</h1>
        <p class="street-name-place">50-лет Октября 26</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(642 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Антикафе «Котейная» — это место, где вы можете провести время в уютной атмосфере, наслаждаясь общением с кошками.</br></p>
