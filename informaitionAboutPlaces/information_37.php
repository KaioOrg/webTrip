...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/museumsPlaces/myhistoryMuseumBlack.png" alt="">
        <h1 class="name-place">Исторический парк "Россия - моя история"</h1>
        <p class="street-name-place">Менделеева 158</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(203 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Мультимедийный исторический парк Россия-моя история является одним из излюбленных культурных пространств, на базе которого организовывается множество разнообразных событий, служащих для интересного времяпрепровождения в Уфе.</br></p>
