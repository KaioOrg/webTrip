...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/memorialsPlaces/zagirMemorialBlack.png" alt="">
        <h1 class="name-place">Памятник Загиру Исмагилову</h1>
        <p class="street-name-place">Ленина, 5, корп. 1</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(16 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">В 2008 году на улице Ленина был поставлен памятник башкирскому композитору Загиру Гариповичу Исмагилову. Это место было выбрано не случайно. Рядом расположен уфимский Театр оперы и балета, где и прозвучали самые знаменитые произведения композитора. Напротив памятника находится Академия искусств. К 40-летнему юбилею этого учебного заведения и была приурочена установка памятника. Именно Загир Исмагилов и был идейным вдохновителем и первым ректором этого заведения, работавшим здесь два десятка лет.</br></p>
