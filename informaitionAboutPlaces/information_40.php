...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/parksPlaces/woodParkBlack.png" alt="">
        <h1 class="name-place">Парк Лесоводов Башкирии</h1>
        <p class="street-name-place">лесопарк им. Лесоводов Башкирии</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="score-count-item"><p class="score-count-label">4,0</p></li>
                <li class="views-count-item"><p class="views-count-label">(2244 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Парк Лесоводов Башкирии в Уфе заслуженно считается одним из лучших мест для отдыха от суеты в башкирской столице. При первом посещении парк может показаться диковатым — здесь не так много инфраструктуры для развлечений. Но в этом и есть его главное достоинство — единение с природой.</br></p>
