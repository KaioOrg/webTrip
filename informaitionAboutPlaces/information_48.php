...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/theatresPlaces/mustaKarimaTheatreBlack.png" alt="">
        <h1 class="name-place">Национальный молодёжный театр им. М. Карима</h1>
        <p class="street-name-place">Ленина 62</p>
    ...
    <main>
        ...
        <section class="all-information">
            ...
            <p class="main-information-about-place">Национальный молодёжный театр (полное название — Национальный молодёжный театр Республики Башкортостан имени Мустая Карима) — один из самых «юных» креативных уфимских коллективов. Находится театр на улице Ленина.</br></p>
