...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/hotelsPlaces/bashkiriaHotelBlack.png" alt="">
        <h1 class="name-place">Гостиница Башкирия</h1>
        <p class="street-name-place">Ленина 25/29</p>
    ...
    <main>
        ...
        <section class="all-information">
            ...
            <p class="main-information-about-place">Гостиница «Башкирия» — это четырехзвездочный отель, расположенный в центре Уфы. Здание гостиницы является историческим памятником республики. В непосредственной близости от отеля находится множество театров, музеев и галерей</br></p>
