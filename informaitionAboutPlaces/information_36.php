...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/theatresPlaces/toysTheatreBlack.png" alt="">
        <h1 class="name-place">Башкирский государственный театр кукол</h1>
        <p class="street-name-place">просп. Октября 158</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(809 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Башкирский театр кукол — культурное заведение с богатой историей и обширным репертуаром. За 85 лет существования он прошел путь от самодеятельного кружка до важного регионального театра. В настоящее время театр является лауреатом российских и международных театральных фестивалей и премий.</br></p>
            <p class="main-information-about-place" >В репертуаре театра не только классические кукольные постановки по мотивам русских и европейских сказок, на его сцене ставят постановки башкирского эпоса, а также современные авторские постановки</br></p>
