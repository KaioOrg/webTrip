...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/memorialsPlaces/mustaiKarimMemorialBlack.png" alt="">
        <h1 class="name-place">Памятник Мустаю Кариму</h1>
        <p class="street-name-place">площадь имени Мустая Карима</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(800 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Сквер был открыт в 2013 году перед зданием Дома профсоюзов. На торжественной церемонии открытия присутствовали премьер-министр башкирского правительства, глава администрации городского округа Уфы, автор скульптурной композиции. Почетными гостями были родственники Мустая Карима и его близкие друзья</br></p>
