...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/parksPlaces/matrosovaParkBlack.png" alt="">
        <h1 class="name-place">Сад Александра Матросова</h1>
        <p class="street-name-place">Тукаева 23</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(89 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Описание отсутствует</br></p>
