...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/entertainmentsPlaces/strangebusienessEntertainmentBlack.png" alt="">
        <h1 class="name-place">Странные дела</h1>
        <p class="street-name-place">Ленина 156</p>
    ...
    <main>
        ...
        <section class="all-information">
            ...
            <p class="main-information-about-place">В нашем уютном Тайм-кафе каждый найдет себе занятие по душе — отдельные комнаты для компаний с разнообразными приставками, настольный теннис, кофейня, сцена для проведения концертов и караоке-вечеров, музыкальные инструменты, 3D кинозона, детская зона, аэрохоккей, настольные игры, кикер, дартс, офисное пространство, виртуальная реальность PS VR и многое другое! У нас вы можете принять участие в музыкальных мероприятиях, спортивных турнирах, игротеках, посетить различные курсы и мастер-классы. Ждем в гости!</br></p>
