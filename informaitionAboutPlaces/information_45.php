...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/memorialsPlaces/mayakovskiMemorialBlack.png" alt="">
        <h1 class="name-place">Памятник В.В. Маяковскому</h1>
        <p class="street-name-place">сквер им. В.В.Маяковского</p>
    ...
    <main>
        ...
        <section class="all-information">
            ...
            <p class="main-information-about-place">Памятник В. В. Маяковскому был установлен в одноименном сквере в городе Уфа в 1960 году. Уфимский памятник является одним из версий данного творения, созданного руками скульптора А. Кибальникова, до этого летом 1958 года состоялось открытие московского памятника.</br></p>
