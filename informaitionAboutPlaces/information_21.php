...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/entertainmentsPlaces/papasclubEntertainmentBlack.png" alt="">
        <h1 class="name-place">Papa's club</h1>
        <p class="street-name-place">Кавказская, 6/8</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(308 отзыва)</p></li>
            </ul>
