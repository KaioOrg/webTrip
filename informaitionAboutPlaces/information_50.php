...
<body>
    <header class="headerPage" >
        ...
        <img class="main-image-place" src="../static/images/entertainmentsPlaces/peintbollEntertainmentBlack.png" alt="">
        <h1 class="name-place">Пейнтбольный парк Рубикон</h1>
        <p class="street-name-place">Комарова 1/2</p>
    ...
    <main>
        ...
        <section class="all-information">
            <ul class="list-stars">
                ...
                <li class="views-count-item"><p class="views-count-label">(224 отзыва)</p></li>
            </ul>

            <p class="main-information-about-place">Отсутствует информация</br></p>
